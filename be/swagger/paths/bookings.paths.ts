// Booking Paths - OpenAPI 3.0 format
  ...
  '/api/bookings': {
    post: {
      ...
      responses: {
        ...
        400: { description: 'Validation error or seats unavailable' },
  ...
  '/api/bookings/{id}': {
    get: {
      ...
      responses: {
        ...
        401: { description: 'Unauthorized' },
        403: { description: 'Forbidden - can only view own bookings' },
  ...
  '/api/bookings/{id}/cancel': {
    put: {
      ...
      responses: {
        ...
        401: { description: 'Unauthorized' },
        403: { description: 'Forbidden - can only cancel own bookings' },
        404: { description: 'Booking not found' },
        500: { description: 'Server error' },
      },
    },
